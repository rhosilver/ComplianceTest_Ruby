...
describe("Barcode Manual Test", function() {
	...
	describe("Barcode Test with selected scannerType" , function() {
		...
		{
			it("VT200-0335 | Enable with callback as function | " + scannerType , function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
			...
			it("VT200-0336 | Enable with alldecoders enabled and callback as function URL | " + scannerType, function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
			...
			xit("VT200-0339 | Enable with picklist " + reticleType + ", scanTimeout 3000 and callback as anonymous function |"+ scnid, function() {
			...
			it("VT200-0341 | take with picklist, scanTimeout 7000 and callback |"+ scannerType, function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
				...
				runs(function(){
					Ruby.call('Barcode','scanner_enable?time=7000&picklist=true&'+getSelectedScannerType());
			...
			it("VT200-0342 | Take with alldecoders disabled, code128 as enabled with callback as function URL |"+ scannerType, function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
			...
			xit("VT200-0343 | Take with callback as anonymous function |"+ scnid, function() {
			...
			if (Rho.System.isMotorolaDevice == true) 
			{
				it("VT200-0344 | autotenter true with setproperty |"+ scannerType, function() {
					displayObjective(jasmine.getEnv().currentSpec.description);
				...
				it("VT200-0345 | set decodeSound to local wave file path |"+ scannerType, function() {
					displayObjective(jasmine.getEnv().currentSpec.description);
			...
			it("VT200-0346 | call getAllProperties() without callback(Sync Access) |"+ scannerType, function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
			...
			it("VT200-0347 | call getSupportedProperties() with async callback |"+ scannerType, function() {
				displayObjective(jasmine.getEnv().currentSpec.description);
